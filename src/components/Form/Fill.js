...
const Fill = (props) => {
  return (
    <div className='collapsible__content'>
      ...
      <InputText id='linkedin' labelText='Linkedin' inputName='linkedin' inputType='text' value={props.linkedin} inputPlaceholder='Ej: linkedin.com/in/sally.hill' handleInput={props.handleInput} />
      <InputText id='github' labelText='Github' inputName='github' inputType='text' value={props.github} inputPlaceholder='Ej: @sally-hill' handleInput={props.handleInput} />
    </div>
  );
};
