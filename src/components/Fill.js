...
<fieldset className="collapsible collapsable--open js-myform">
  ...
  <div className="collapsible__content">
    <div>
      <label className="collapsible__content--style-text required" htmlFor="fullname"> Nombre completo</label>
      <input className="js-input-name js-input-text collapsible__content--input-form" placeholder="Ej: Sally Jill" type="text" id="fullname" name="name" required />
    </div>
    <div>
      <label className="collapsible__content--style-text required" htmlFor="job"> Puesto</label>
      <input className="js-input-job js-input-text collapsible__content--input-form" placeholder="Ej: Front-end" type="text" id="job" name="job" required />
    </div>
